...
export const agencyData = [
  {
    ...
    review: 'Recognised as one of Manchester\'s Top Rated AI agencies, CCwithAI.com leads the charge in innovative AI solutions and strategic implementation. They are dedicated to empowering businesses with cutting-edge artificial intelligence and automation, driving growth and efficiency in the Manchester tech ecosystem.',
    isFeatured: true,
    logoChar: 'C',
  },
  {
